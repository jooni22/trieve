...
models = {
    "baai/bge-m3": SentenceTransformer('baai/bge-m3', model_kwargs={"attn_implementation": "eager"}),
    "mixedbread-ai/mxbai-embed-large-v1": SentenceTransformer("mixedbread-ai/mxbai-embed-large-v1", truncate_dim=dimensions)
}
